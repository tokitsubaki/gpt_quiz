...
class _$_Quiz implements _Quiz {
  ...
  @override
  String toString() {
    return 'Quiz(question: $question, choices: $choices, answer: $answer, description: $description)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, question,
      const DeepCollectionEquality().hash(_choices), answer, description);
...
abstract class _Quiz implements Quiz {
  const factory _Quiz(
      ...
      required final String description}) = _$_Quiz;
